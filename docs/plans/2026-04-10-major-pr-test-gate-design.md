...
constraints:
  - Use ADB real-device verification on `<TARGET_DEVICE_IP>:5555`
...
verification_contract:
  verify_steps:
    ...
    - install apk: adb -s <TARGET_DEVICE_IP>:5555 install -r .\webdavtoon-debug.apk
