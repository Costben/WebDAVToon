...
- confirm: ADB evidence on `<TARGET_DEVICE_IP>:5555` shows the special-character WebDAV video path launches to VLC (or the configured external player) instead of failing during handoff
