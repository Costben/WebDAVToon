...
action: Install the latest debug build on `<TARGET_DEVICE_IP>:5555`, switch to the affected dark-mode views, and collect screenshot/UI/activity/log evidence for the settings page and folder list.
loop: false
verify:
  - type: artifact
