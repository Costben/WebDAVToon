...
class AppSettingsStore(context: Context) {
    ...
    companion object {
        ...
        val VIDEO_GESTURE_ENABLED = booleanPreferencesKey("video_gesture_enabled")
        val VIDEO_DOUBLE_TAP_SEEK_SECONDS = intPreferencesKey("video_double_tap_seek_seconds")
