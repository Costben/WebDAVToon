...
action: Install the latest debug build on `<TARGET_DEVICE_IP>:5555`, reproduce external playback for the special-character WebDAV path under `Videos/PMV/b站同衣服91v/`, and collect screenshot/activity/log evidence showing the external handoff succeeds.
loop: false
verify:
  - type: artifact
